...
*/
console.log('task 1b', createMenuItem('Chicken Noodle', 3, 'Lunch'));
console.log('task 1b', createMenuItem('Waffle', 5, 'Breakfast'));
console.log('task 1b', createMenuItem('Steak', 10, 'Dinner'));
